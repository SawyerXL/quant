...
# 2026-09-05 重跑: DEFAULT_CONFIG已含降档3%与pool30, 本次跑当前部署口径
CURRENT = {"pool_size": 30, "lot_size": 100, "initial_capital": 500_000.0}
...
def main():
    ...
    for off in range(10):
        ...
        cfg = BacktestConfig(**{**DEFAULT_CONFIG.to_dict(), **CURRENT})
    ...
    # 单路径对照: 现网口径
    from backtest_config import BacktestConfig as _BC
    nav0, _ = run_backtest(panel, ap, path(0), _BC(**{**DEFAULT_CONFIG.to_dict(), **CURRENT}), ic)
